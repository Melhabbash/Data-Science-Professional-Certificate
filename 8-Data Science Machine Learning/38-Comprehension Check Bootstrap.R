...
#Q1
#The createResample function can be used to create bootstrap samples. For example, we can create 
# 10 bootstrap samples for the mnist_27 dataset like this:
...
#########################################################################################################
#Q2
#We see that some numbers appear more than once and others appear no times. This has to be this way 
# for each dataset to be independent. Repeat the exercise for all the resampled indexes.
...
# Set the seed to 1 again after generating y and use 10 bootstrap samples to estimate the expected 
# value and standard error of the 75th quantile.
...
########################################################################################################
#Q6
# When doing bootstrap sampling, the simulated samples are drawn from the empirical distribution of 
# the original data.
# 
# True or False: The bootstrap is particularly useful in situations when we do not have access to 
# the distribution or it is unknown.
# 
# 
# True  (True)
# False
# 
# True. The bootstrap is particularly useful in situations when we do not have access to the 
# distribution or it is unknown.
