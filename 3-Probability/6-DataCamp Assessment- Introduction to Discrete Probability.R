...
# 
# One ball will be drawn at random from a box containing: 3 cyan balls, 5 magenta 
# balls, and 7 yellow balls.
# 
...
# We defined the variable p as the probability of choosing a cyan ball from 
...
# `p` is defined as the probability of choosing a cyan ball from a box containing: 
# 3 cyan balls, 5 magenta balls, and 7 yellow balls.
# Using variable `p`, calculate the probability of choosing any ball that is not 
# cyan from the box
1-p
##########################
# 
# Exercise 3. Sampling without replacement - generalized
# Instead of taking just one draw, consider taking two draws. You take the second
# draw without returning the first draw to the box. We call this sampling without
# replacement.
# 
# What is the probability that the first draw is cyan and that the second draw is 
# not cyan?
# 
# Calculate the conditional probability p_2 of choosing a ball that is not cyan 
# after one cyan ball has been removed from the box.
# Calculate the joint probability of both choosing a cyan ball on the first draw 
# and a ball that is not cyan on the second draw using p_1 and p_2.
...
# What is the probability that the first draw is cyan and that the second draw is
# not cyan?
# Calculate the probability p_2 of choosing a ball that is not cyan on the second
# draw, with replacement.
# Next, use p_1 and p_2 to calculate the probability of choosing a cyan ball on 
# the first draw and a ball that is not cyan on the second draw (after replacing 
# the first ball).
...
p_2<-(magenta+yellow)/(magenta+yellow+cyan)
# Calculate the probability that the first draw is cyan and the second draw is 
# not cyan using `p_1` and `p_2`.
p_1*p_2
