# Imagine you draw two balls from a box containing colored balls. You either replace the first ball 
# before you draw the second or you leave the first ball out of the box when you draw the second ball.
# 
...
# If you roll a 6-sided die once, what is the probability of not seeing a 6? If you roll a 6-sided 
# die six times, what is the probability of not seeing a 6 on any of those rolls?

# Assign the variable 'p_no6' as the probability of not seeing a 6 on a single roll.
p_no6<-5/6
# Calculate the probability of not seeing a 6 on six rolls using `p_no6`. Print your result to the 
# console: do not assign it to a variable.
(p_no6)^6


##############################
# Exercise 4. Probability the Celtics win a game
# Two teams, say the Celtics and the Cavs, are playing a seven game series. The Cavs are a better 
# team and have a 60% chance of winning each game.
# 
# What is the probability that the Celtics win at least one game? Remember that the Celtics must win 
# one of the first four games, or the series will be over!

# Assign the variable `p_cavs_win4` as the probability that the Cavs will win the first four games of 
# the series.
p_cavs_win4<-(0.6)^4

# Using the variable `p_cavs_win4`, calculate the probability that the Celtics win at least one game 
...
# 
# Use the replicate function for B <- 10000 simulations of a four game series. The results of 
# replicate should be stored to a variable named celtic_wins.
# Within each simulation, replicate the sample code to simulate a four-game series named 
# simulated_games. Then, use the any function to indicate whether the four-game series contains at 
# least one win for the Celtics. Perform these operations in two separate steps.
# Use the mean function on celtic_wins to find the proportion of simulations that contain at least 
# one win for the Celtics out of four games.
