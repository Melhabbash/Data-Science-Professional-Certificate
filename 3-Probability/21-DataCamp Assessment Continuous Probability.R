...
# Assume the distribution of female heights is approximated by a normal distribution with a mean of 64 inches 
# and a standard deviation of 3 inches. If we pick a female at random, what is the probability that 
# she is 5 feet or shorter?
#   
...
# Assume the distribution of female heights is approximated by a normal distribution with a mean 
# of 64 inches and a standard deviation of 3 inches. If we pick a female at random, what is the 
# probability that she is 6 feet or taller?
...
# is 6 feet or taller. Print this value to the console.
...
# Assume the distribution of female heights is approximated by a normal distribution with a mean of 64 inches 
# and a standard deviation of 3 inches. If we pick a female at random, what is the probability that 
# she is between 61 and 67 inches?
...
# Repeat the previous calculation using pnorm to define the probability that a randomly chosen woman will 
# have a height between 61 and 67 inches, converted to centimeters by multiplying each value by 2.54.
...
# Calculate the probability that a randomly selected female is between the desired height range. Print this 
# value to the console.
pnorm(taller,female_avg,female_sd)-pnorm(shorter,female_avg,female_sd)
########################################################

# Exercise 6. Distribution of male heights
# Imagine the distribution of male adults is approximately normal with an average of 69 inches and 
# a standard deviation of 3 inches. How tall is a male in the 99th percentile?

# Determine the height of a man in the 99th percentile, given an average height of 69 inches and a standard 
...
# The distribution of IQ scores is approximately normally distributed. The average is 100 and the standard deviation 
# is 15. Suppose you want to know the distribution of the person with the highest IQ in your school district, 
...
# Use the function rnorm to generate a random distribution of 10,000 values with a given average and
# standard deviation.
